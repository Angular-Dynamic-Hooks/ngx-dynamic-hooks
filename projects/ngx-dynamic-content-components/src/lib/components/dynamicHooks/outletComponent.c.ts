...
@Component({
  selector: 'ngx-dynamiccontentcomponents',
  template: '',
  styles: []
})
export class OutletComponent implements DoCheck, OnInit, OnChanges, AfterViewInit, AfterViewChecked, OnDestroy {
  ...
  constructor(
    ...
    @Optional() @Inject(DYNAMICCONTENTCOMPONENTS_GLOBALSETTINGS) private globalSettings: DynamicContentComponentsGlobalSettings,
