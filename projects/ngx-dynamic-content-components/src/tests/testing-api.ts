/*
 * Testing API Surface of ngx-dynamic-content-components
 * This serves as an abstraction layer for all testing files to request their resources from the main library
 */

// Public module resources
export { DYNAMICCONTENTCOMPONENTS_GLOBALSETTINGS, DynamicContentComponentsGlobalSettings } from '../lib/globalSettings';
export { DynamicContentChildren, OnDynamicChanges, OnDynamicMount, OnDynamicData, HookParser, HookPosition, HookValue, HookData, HookBindings } from '../lib/interfacesPublic';
