...
// Attribute regex
regexes.attributeNameNoBracketsRegex = '(' + variableNameRegex + ')';
regexes.attributeNameBracketsRegex = '\\[(' + variableNameRegex + ')\\]';
regexes.attributeNameRoundBracketsRegex = '\\((' + variableNameRegex + ')\\)';
...
regexes.variablePathDotNotation = '\\.' + variableNameRegex;
...
regexes.placeholderVariablePathDotNotation = '\\@@@cxtDot@@@' + variableNameRegex;
